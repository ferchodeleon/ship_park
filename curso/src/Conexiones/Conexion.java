...
public class Conexion {
    ...
    public static Connection getConexion(){
        status = false;
        String url = "jdbc:sqlserver://localhost:1433;databaseName=PROYECTO_FINAL";
        try {
        ...
        try{
            contacto = java.sql.DriverManager.getConnection(url, Conexion.usuario, Conexion.password);
            status = true;
